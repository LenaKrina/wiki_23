...
public class AppManager {
    ...
    public void init() throws MalformedURLException {
        ...
        capabilities.setCapability("app", "C:/Users/Elena/Documents/GitHub/wiki_23/apk/org.wikipedia.apk");
    ...
    private void createList(String text) {
        waitForElementAndType((By.xpath("//[@resource-id='org.wikipedia:id/text_input']")), 20, text);
    }
    ...
    private void initAddToFavorite() {
    ...
    public String getArticleName() {
      return driver.findElement(By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']")).getText();
    }
}
